...
public class TunnelDetailPeerBindingImpl extends TunnelDetailPeerBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.rostamvpn.android.config.Peer) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.rostamvpn.android.config.Peer Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        java.util.Optional<com.rostamvpn.android.config.InetEndpoint> itemEndpoint = null;
        boolean itemPreSharedKeyIsPresent = false;
        com.rostamvpn.android.config.Peer item = mItem;
        boolean ItemPreSharedKeyIsPresent1 = false;
        com.rostamvpn.android.crypto.Key itemPublicKey = null;
        ...
        java.util.Optional<com.rostamvpn.android.crypto.Key> itemPreSharedKey = null;
        ...
        java.util.Set<com.rostamvpn.android.config.InetNetwork> itemAllowedIps = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setInetNetworkSetText(this.allowedIpsText, itemAllowedIps);
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setOptionalText(this.endpointText, itemEndpoint);
