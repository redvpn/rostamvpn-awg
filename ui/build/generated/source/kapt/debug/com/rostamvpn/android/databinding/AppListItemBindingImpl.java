...
public class AppListItemBindingImpl extends AppListItemBinding implements com.rostamvpn.android.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener selectedCheckboxandroidCheckedAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // item
            com.rostamvpn.android.model.ApplicationData item = mItem;
            // item != null
    ...
    private AppListItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.rostamvpn.android.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.rostamvpn.android.model.ApplicationData) variable);
        }
        else if (BR.collection == variableId) {
            setCollection((com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ApplicationData>) variable);
        }
    ...
    public void setItem(@Nullable com.rostamvpn.android.model.ApplicationData Item) {
    ...
    public void setCollection(@Nullable com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ApplicationData> Collection) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((com.rostamvpn.android.model.ApplicationData) object, fieldId);
            case 1 :
                return onChangeCollection((com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ApplicationData>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(com.rostamvpn.android.model.ApplicationData Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCollection(com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ApplicationData> Collection, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
