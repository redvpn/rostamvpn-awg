...
public class TunnelEditorPeerBindingImpl extends TunnelEditorPeerBinding implements com.rostamvpn.android.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener allowedIpsTextandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // item
            com.rostamvpn.android.viewmodel.PeerProxy item = mItem;
            // item != null
    ...
    private TunnelEditorPeerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new com.rostamvpn.android.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.rostamvpn.android.viewmodel.PeerProxy) variable);
        }
            ...
            setCollection((androidx.databinding.ObservableList<com.rostamvpn.android.viewmodel.PeerProxy>) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.rostamvpn.android.viewmodel.PeerProxy Item) {
    ...
    public void setCollection(@Nullable androidx.databinding.ObservableList<com.rostamvpn.android.viewmodel.PeerProxy> Collection) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((com.rostamvpn.android.viewmodel.PeerProxy) object, fieldId);
            case 1 :
                return onChangeCollection((androidx.databinding.ObservableList<com.rostamvpn.android.viewmodel.PeerProxy>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(com.rostamvpn.android.viewmodel.PeerProxy Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeCollection(androidx.databinding.ObservableList<com.rostamvpn.android.viewmodel.PeerProxy> Collection, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7f9L) != 0) {
            ...
            if ((dirtyFlags & 0x421L) != 0) {
                    ...
                    bindingAdaptersTryParseIntItemPersistentKeepalive = com.rostamvpn.android.databinding.BindingAdapters.tryParseInt(itemPersistentKeepalive);
        ...
        if ((dirtyFlags & 0x400L) != 0) {
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setFilter(this.preSharedKeyText, com.rostamvpn.android.widget.KeyInputFilter.newInstance());
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setFilter(this.publicKeyText, com.rostamvpn.android.widget.KeyInputFilter.newInstance());
        ...
        if ((dirtyFlags & 0x404L) != 0) {
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setOnFocusChange(this.preSharedKeyText, fragmentOnKeyFocusChangeAndroidViewViewOnFocusChangeListener);
        }
        if ((dirtyFlags & 0x411L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        ...
        public OnClickListenerImpl setValue(com.rostamvpn.android.fragment.TunnelEditorFragment value) {
            this.value = value;
