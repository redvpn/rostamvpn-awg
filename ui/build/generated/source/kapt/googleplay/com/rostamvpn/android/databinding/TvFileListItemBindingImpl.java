...
public class TvFileListItemBindingImpl extends TvFileListItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.rostamvpn.android.activity.TvMainActivity.KeyedFile) variable);
        }
    ...
    public void setItem(@Nullable com.rostamvpn.android.activity.TvMainActivity.KeyedFile Item) {
        this.mItem = Item;
    }
