...
public class TvActivityBindingImpl extends TvActivityBinding  {
    ...
    // variables
    // values
    private com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.activity.TvMainActivity.KeyedFile> mOldFiles;
    private int mOldAndroidLayoutTvFileListItem;
    private com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldFilesRowConfigurationHandler;
    private com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ObservableTunnel> mOldTunnels;
    private int mOldAndroidLayoutTvTunnelListItem;
    private com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler mOldTunnelRowConfigurationHandler;
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.filesRoot == variableId) {
            ...
            setFiles((com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.activity.TvMainActivity.KeyedFile>) variable);
        }
        else if (BR.filesRowConfigurationHandler == variableId) {
            setFilesRowConfigurationHandler((com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
            ...
            setTunnels((com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ObservableTunnel>) variable);
        }
        else if (BR.tunnelRowConfigurationHandler == variableId) {
            setTunnelRowConfigurationHandler((com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFiles(@Nullable com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.activity.TvMainActivity.KeyedFile> Files) {
    ...
    public void setFilesRowConfigurationHandler(@Nullable com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler FilesRowConfigurationHandler) {
    ...
    public void setTunnels(@Nullable com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ObservableTunnel> Tunnels) {
    ...
    public void setTunnelRowConfigurationHandler(@Nullable com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler TunnelRowConfigurationHandler) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeFiles((com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.activity.TvMainActivity.KeyedFile>) object, fieldId);
            case 2 :
                return onChangeIsDeleting((androidx.databinding.ObservableBoolean) object, fieldId);
            case 3 :
                return onChangeTunnels((com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ObservableTunnel>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFiles(com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.activity.TvMainActivity.KeyedFile> Files, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeTunnels(com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ObservableTunnel> Tunnels, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.activity.TvMainActivity.KeyedFile> files = mFiles;
        ...
        com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> filesRowConfigurationHandler = mFilesRowConfigurationHandler;
        ...
        com.rostamvpn.android.databinding.ObservableKeyedArrayList<java.lang.String,com.rostamvpn.android.model.ObservableTunnel> tunnels = mTunnels;
        boolean tunnelsIsEmpty = false;
        java.lang.String filesRootGet = null;
        com.rostamvpn.android.databinding.ObservableKeyedRecyclerViewAdapter.RowConfigurationHandler<? extends androidx.databinding.ViewDataBinding,?> tunnelRowConfigurationHandler = mTunnelRowConfigurationHandler;
        ...
        if ((dirtyFlags & 0x52L) != 0) {
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setItems(this.filesList, this.mOldFiles, this.mOldAndroidLayoutTvFileListItem, this.mOldFilesRowConfigurationHandler, files, R.layout.tv_file_list_item, filesRowConfigurationHandler);
        }
        if ((dirtyFlags & 0x49L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x68L) != 0) {
            ...
            com.rostamvpn.android.databinding.BindingAdapters.setItems(this.tunnelList, this.mOldTunnels, this.mOldAndroidLayoutTvTunnelListItem, this.mOldTunnelRowConfigurationHandler, tunnels, R.layout.tv_tunnel_list_item, tunnelRowConfigurationHandler);
        }
        if ((dirtyFlags & 0x52L) != 0) {
